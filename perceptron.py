    ...
    for shuffle_value in r: #iterates over r
        ...
        for algorithm in algorithms: #iterates over the algorithms
            ...
            if algorithm == 'Perceptron':
                clf = Perceptron(eta0=learning_rate, shuffle=shuffle_value, max_iter=1000)
            else:
            ...
            if algorithm == 'Perceptron':
                if accuracy > highest_perceptron_accuracy:
                    ...
                    print("Highest Perceptron accuracy so far: " + str(accuracy) +
                          ", Parameters: learning rate=" + str(learning_rate) +
                          ", shuffle=" + str(shuffle_value))
            else:
                if accuracy > highest_mlp_accuracy:
                    highest_mlp_accuracy = accuracy
                    print("Highest MLP accuracy so far: " + str(accuracy) +
                          ", Parameters: learning rate=" + str(learning_rate) +
                          ", shuffle=" + str(shuffle_value))
